...
// Catch any unhandled exceptions during application startup and log them as fatal errors
catch (Exception ex)
{
    Log.Fatal(ex, "Application failed to start correctly");
}

// Ensure all buffered log messages are written to their targets before the application terminates
finally
{
    Log.CloseAndFlush();
}
